                ...
                if (49 <= key && key <= 57)
                {
                    ...
                    switch (key)
                    {
                        case 50:
                            ...
                            prefix = "escalator2nd_";
                            break;

                        case 51:
                            trimRect = escalator3rd;
                            prefix = "escalator3rd_";
                            break;

                        default:
                            trimRect = escalator1st;
                            prefix = "escalator1st_";
                            break;
                    }
